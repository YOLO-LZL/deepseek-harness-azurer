...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.workspace.createMethod',
    kind: 'list',
    scope: 'root',
    summary: 'Workspace create methods under the conversation picker (declared by WorkspacePicker; ui-ssh registers the SSH method).',
    doc: 'Workspace create methods under the conversation picker (declared by WorkspacePicker; ui-ssh registers the SSH method).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.workspace.createMethod\', () => ctx.slots.register(\n      { name: \'conversation.hero.workspace.createMethod\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:78',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-ssh SshConnectionsSection id \'ssh-connections\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.workspaces.createMethod',
    kind: 'list',
    scope: 'root',
    summary: 'Workspace create methods under the sidebar browser (declared by WorkspaceBrowser; ui-ssh registers the SSH method).',
    doc: 'Workspace create methods under the sidebar browser (declared by WorkspaceBrowser; ui-ssh registers the SSH method).',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.createMethod\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.createMethod\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
