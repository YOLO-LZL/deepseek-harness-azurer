...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-provider-invalid-target'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-remote-path-invalid'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('execution-unavailable'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('execution-provider-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
