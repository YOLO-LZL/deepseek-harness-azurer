...
export interface RpcMethodMap {
  ...
  'host.sshStatus': HostApi['sshStatus']
  'host.sshListDirectory': HostApi['sshListDirectory']
  'host.sshCreateDirectory': HostApi['sshCreateDirectory']
  'host.sshProbe': HostApi['sshProbe']
