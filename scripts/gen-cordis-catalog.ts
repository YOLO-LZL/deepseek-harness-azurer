...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ExecutionLocation: 'workspace.md',
  WorkspaceCreateInput: 'workspace.md',
  WorkspaceProviderOperations: 'workspace.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExecutionWorldProvider: 'execution-world provider registration is owned by packages/execution/execution-world/README.md',
  ResolvedExecutionWorld: 'resolved execution-world backends are owned by packages/execution/execution-world/README.md',
  SshConnection: 'saved SSH connection records are owned by packages/ssh/ssh/README.md',
  SshConnectionsSettings: 'SSH settings namespace is owned by packages/ssh/ssh/README.md',
  SshConfigHost: 'discovered OpenSSH alias facts are owned by packages/ssh/ssh/README.md',
  SshTarget: 'resolved SSH command targets are owned by packages/ssh/ssh/README.md',
  SshTargetReference: 'SSH location target references are owned by packages/ssh/ssh/README.md',
  SshTransport: 'SSH transport lifetime is owned by packages/ssh/ssh/README.md',
  SshTransportTarget: 'resolved SSH transport facts are owned by packages/ssh/ssh/README.md',
