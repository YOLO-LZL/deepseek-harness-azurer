...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-ssh': { kind: 'none', reason: 'Browser-side SSH settings and workspace-create UI; the host and tool packages own model-visible behavior.' },
  ...
  'packages/execution/execution-location': { kind: 'none', reason: 'Location and error types only; providers and consumers own every model-visible effect.' },
  'packages/execution/execution-world': { kind: 'indirect', reason: 'The registry routes providers; tools and context consumers own model-visible behavior.' },
  'packages/ssh/fs-ssh': { kind: 'indirect', reason: 'The remote filesystem backend delegates model rendering to dsh-tool-fs.' },
  'packages/ssh/ssh': { kind: 'indirect', reason: 'The runtime supplies connections and transports; dsh-tool-ssh and workspace consumers own model-visible behavior.' },
  'packages/ssh/subprocess-ssh': { kind: 'indirect', reason: 'The remote subprocess backend delegates model rendering to its shell and terminal consumers.' },
  'packages/ssh/workspace-ssh': { kind: 'indirect', reason: 'The SSH workspace provider is consumed by workspace and tool packages that own model-visible behavior.' },
